...
public class LibrarySeedService {
    ...
    public void seed() {
        ...
        BookEntity book2 = new BookEntity(null, "To Kill a Mockingbird", "Harper Lee", "9780061120084", true, LocalDate.of(2021, 3, 15), "Alice123");

        BookEntity book3 = new BookEntity(null, "1984", "George Orwell", "9780451524935", true, LocalDate.of(2021, 4, 5), "Bob456");

        BookEntity book4 = new BookEntity(null, "The Great Gatsby", "F. Scott Fitzgerald", "9780743273565", true, LocalDate.of(2021, 5, 1), "Carol789");

        BookEntity book5 = new BookEntity(null, "Moby Dick", "Herman Melville", "9780142437247", false, null, null);

        BookEntity book6 = new BookEntity(null, "War and Peace", "Leo Tolstoy", "9780140447934", true, LocalDate.of(2021, 6, 20), "David321");

        BookEntity book7 = new BookEntity(null, "The Catcher in the Rye", "J.D. Salinger", "9780316769488", false, null, null);

        BookEntity book8 = new BookEntity(null, "Pride and Prejudice", "Jane Austen", "9780141439518", true, LocalDate.of(2021, 7, 10), "Emily654");

        BookEntity book9 = new BookEntity(null, "The Lord of the Rings", "J.R.R. Tolkien", "9780618640157", true, LocalDate.of(2021, 8, 5), "Frank789");
